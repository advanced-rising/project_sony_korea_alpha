const domesticDataPath = "../data/domesticeData.json";
fetch(domesticDataPath)
  ...
  .then((response)=>{
    ...
    const domesticCode = `<div class="pro_img"></div><div class="pro_txt"><span></span></div><div class="pro_profile"><div class="profile_img"><a href="#"><span></span></a></div><div class="img_txt"><a href="#"><p></p></a></div></div>` 
